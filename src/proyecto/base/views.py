...
from django.urls import reverse_lazy    #redireccionamiento
...
class PaginaRegistro(FormView):
    ...
    #esto era para no dejarme ver la pag de registro pero fallo
    #redirect_authenticated_user = True
    ...
    def form_valid(self, form):
        ...
        #nos devuelve a la instancia superior con toda la informacion
        return super(PaginaRegistro, self).form_valid(form)


    #con esto decimos que no me muestre la pagina de registro estando logeado
